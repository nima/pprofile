...
def main():
    ...
    group = parser.add_argument_group(
        ...
        description='Allows excluding (and re-including) code from '
            '"file names" matching regular experssions. '
            'A "file name" may contain a path, and follows the '
            'semantic of python\'s "co_filename" code object properties. '
    )
    group.add_argument('--exclude-syspath', action='store_true',
        help='Exclude all of sys.path .')
